...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_register_script( 'bootstrap', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js', array(), '3.3.6', true );
    wp_register_script( 'map-bootstrap', get_template_directory_uri() . '/library/js/libs/bootstrap.min.js.map', array(), '', true );
    wp_register_script( 'jInvertScroll', get_template_directory_uri() . '/library/js/libs/jquery.jInvertScroll.js', array(), '', false );
    wp_register_script( 'rellax', get_template_directory_uri() . '/library/js/libs/rellax.min.js', array(), '', false );
    ...
    wp_register_style( 'bones-stylesheet', get_template_directory_uri() . '/library/less/style.css', array(), '', 'all' );
    ...
    */
    ...
    wp_enqueue_script( 'jInvertScroll');
