...
<?php if(get_field('bild_undersida', get_option('page_for_posts'))): ?>
 <div class="intro-sub animated fadeIn undersida-img" style="background-image: url('<?php the_field('bild_undersida',get_option('page_for_posts')); ?>'); background-position: center center; background-size:cover;">
<?php endif; ?>

<div class="intro-text">
   <h1 class="animated fadeInUp anim-delay-400">Aktuellt</h1>
 </div>
</div>
