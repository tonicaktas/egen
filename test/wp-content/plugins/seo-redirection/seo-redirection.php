...
{
	define( 'WP_SEO_REDIRECTION_VERSION', '4.7'); 
}
...
<div class="wrap pro"><h4>Upgrade to <a target="_blank" href="http://www.clogica.com/product/seo-redirection-premium-wordpress-plugin">pro version</a> to manage 404 errors and empower your site seo&nbsp;&nbsp;&nbsp;<strong style="color:yellow; background-color:red; padding:3px;"> NOW 50% OFF </strong> ,The discount won\'t last long, so don\'t miss the best deal</h4></div>
...
global $util;
	...
	echo '<div class="wrap"><h2>SEO Redirection Free</h2><h4>Upgrade to <a target="_blank" href="http://www.clogica.com/product/seo-redirection-premium-wordpress-plugin">pro version</a> to manage 404 errors and empower your site seo&nbsp;&nbsp;&nbsp;<strong style="color:yellow; background-color:red; padding:3px;"> NOW 50% OFF </strong> ,The discount won\'t last long, so don\'t miss the best deal</h4>';
